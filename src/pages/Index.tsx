  ...
  return (
    <AppLayout>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-5">
        {/* Quick Access */}
        <TiltCard>
          <div className="relative bg-card rounded-2xl p-4 shadow-sm border border-border group overflow-hidden h-full">
      ...
      {isAdmin && (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-5">
          <TiltCard>
            <div className="relative bg-card rounded-2xl p-4 shadow-sm border border-destructive/20 group overflow-hidden h-full">
            ...
            <div className="relative bg-card rounded-2xl p-4 shadow-sm border border-destructive/20 group overflow-hidden h-full">
              ...
              <div className="relative">
                <div className="flex items-center gap-2 mb-2.5">
                  ...
                  <p className="text-[10px] font-bold text-destructive/70 uppercase tracking-widest">Resolv./Canc.</p>
                </div>
