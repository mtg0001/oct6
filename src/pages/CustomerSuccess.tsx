...
import { useSolicitacoesCS } from "@/hooks/useSolicitacoes";
...
const CustomerSuccess = () => {
  ...
  const solicitacoes = useSolicitacoesCS(storeStatus);
  ...
  return (
    <AppLayout>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-foreground">CS - Customer Success</h1>
        ...
        {filtered.map((sol) => {
          ...
          return (
            ...
            >
              ...
              <Button size="sm" onClick={() => navigate(`/cs/${filtro || "pendentes"}/solicitacao/${sol.id}`)}>
                Ver
              </Button>
            </div>
          );
