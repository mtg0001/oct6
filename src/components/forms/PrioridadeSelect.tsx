...
export function PrioridadeBadge({ value }: { value: string }) {
  ...
  if (!p) return null;
  return (
    <span className={`inline-flex items-center justify-center gap-1.5 w-[170px] shrink-0 px-3 py-1 rounded-full text-xs font-bold text-white whitespace-nowrap ${p.color} animate-[pulse_2s_cubic-bezier(0.4,0,0.6,1)_infinite] shadow-sm`}>
